...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">{{ __('SSL Certificates') }}</h1>
        <p class="text-gray-600 mt-1">{{ __('Manage your SSL certificates and their validation status') }}</p>
    </div>
